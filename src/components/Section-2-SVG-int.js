...
export default function SVG2() {
  return (
    <svg
      className="Card-SVG Card-SVG-int"
    ...
    >
      <defs>
        ...
        <linearGradient
          ...
          x2="485.72"
          y2="71.12"
          xlinkHref="#341b0e5e-a21f-44db-b85f-76180f33f0d3"
        />
        <linearGradient
      ...
      <line
        ...
        stroke-width="2"
      />
      <circle cx="485.72" cy="79" r="4" fill="#92d4b1" />
      <circle
        cx="485.72"
        cy="46"
        r="4"
      ...
      <line
        ...
        stroke-width="2"
      />
      <circle cx="485.72" cy="251" r="4" fill="#92d4b1" />
      <line
        x1="305.72"
        y1="168.5"
        x2="274.22"
      ...
      <line
        ...
        stroke-width="2"
      />
      <circle cx="333.22" cy="168.5" r="4" fill="#92d4b1" />
      <g opacity="0.1">
      ...
      <line
        ...
        stroke-width="2"
      />
      <circle cx="637.22" cy="168.5" r="4" fill="#92d4b1" />
      <circle
        cx="686.22"
        cy="168.5"
        r="4"
